...
- [ ] **FND-01**: Site is rebuilt in Astro with the existing draft's visual design preserved (dark theme, pink #f3a9bd accent, Prata + Golos Text, all sections and layout)
- [ ] **FND-02**: Fonts (Prata, Golos Text) are self-hosted — no Google Fonts dependency (throttled in Russia)
...
- [ ] **FND-06**: Site is deployed to Vercel
- [ ] **FND-07**: Search indexing is disabled via an env-gated noindex (robots meta + X-Robots-Tag), toggleable to public at launch without code changes
